...
def make_optimizer(model, opt):
    ...
    def is_reg_head_param(pn):
        return (
            pn.startswith("past_reg_head.")
            or pn.startswith("future_reg_head.")
            or ".past_reg_head." in pn
            or ".future_reg_head." in pn
        )
    ...
    assert len(missing_grouped) == 0, (
        ...
        "Please check module name prefixes such as vid_net/text_net/fusion/cls_head/past_reg_head/future_reg_head."
    )
